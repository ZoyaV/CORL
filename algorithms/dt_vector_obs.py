...
class DecisionTransformer(nn.Module):
    def __init__(
     ...
     #   print(action_dim)
        ...
        self.action_emb = nn.Linear(5, embedding_dim)
    ...
    def forward(
      ...
      #  print(time_emb.shape)
       ...
       # exit()
        ...
        emb = self.action_emb(actions.to(torch.float32))
       # print(emb.shape)
       # print("-------")
        act_emb = emb + time_emb
       # act_emb = self.action_emb(actions.to(torch.float32)) + time_emb
        emb = self.return_emb(returns_to_go.to(torch.float32).unsqueeze(-1))
      #  print(returns_to_go.shape)
      #  print(emb.shape)
        returns_emb = emb + time_emb
